...
export default function HomePage() {
  ...
  return <div className={styles.page}><Header /><main>
    ...
    </div><aside className={styles.choiceBoard} aria-label="AI選びの利用イメージ"><div className={styles.boardHead}><span>選び方の例</span><small>文章・資料を作りたい</small></div><div className={styles.boardQuestion}><span aria-hidden="true">01</span><div><small>やりたいこと</small><strong>長い資料を読み、要点を整える</strong></div></div><div className={styles.boardCandidates}><p>比較候補</p><div><span><b>Ch</b>ChatGPT</span><span><b>Cl</b>Claude</span></div></div><div className={styles.boardChecks}><span>機能</span><span>料金</span><span>入力データ</span></div><a href="/compare/claude-vs-chatgpt">この2つの違いを見る <b aria-hidden="true">→</b></a></aside></div></div></header>
