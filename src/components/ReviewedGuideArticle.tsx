...
export default function ReviewedGuideArticle({ article, attribution }: {
  ...
  const label = freeGuide ? "無料AIの選び方" : chatgpt ? "ChatGPTのモデル・プラン" : grok ? "Grokの利用ガイド" : safety ? "AI安全性の確認ガイド" : search ? "AI検索の比較ガイド" : agents ? "AIエージェントの選び方" : coding ? "開発支援の選び方" : "AIモデルの更新を読む";
      ...
      <header className={styles.hero}>
        <div className={styles.container}>
          ...
          <section className={styles.summary} aria-labelledby="article-summary">
            ...
            <p>{news || chatgpt || freeGuide ? article.description : takeaway}</p>
